...
def simple_model():
    model = nn.Sequential(
        nn.Conv1d(in_channels=1, out_channels=128, kernel_size=50, stride=25, bias=False), #1
        nn.MaxPool1d(kernel_size=8, stride=8),
        nn.Dropout(p=0.5),
        nn.Conv1d(in_channels=128, out_channels=128, kernel_size=8, stride=1, padding=3 , bias=False), #2
        nn.Conv1d(in_channels=128, out_channels=128, kernel_size=8, stride=1, padding=3 ,bias=False), #3
        nn.Conv1d(in_channels=128, out_channels=128, kernel_size=8, stride=1, padding=3 ,bias=False), #4
